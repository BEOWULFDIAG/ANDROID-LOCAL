...
public final class ActivitySetupBinding implements ViewBinding {
  ...
  private ActivitySetupBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull Button retryButton, @NonNull TextView statusText) {
  ...
  public static ActivitySetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySetupBinding((LinearLayout) rootView, progressBar, retryButton,
          statusText);
    }
